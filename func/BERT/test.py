...
# Tải mô hình nhận diện thực thể của spaCy
nlp = spacy.load("en_core_web_sm")

# Văn bản cần trích xuất thông tin
text = r"""
4
Shree
...
_Ƒ triềuchữ ¡ khác bao gồm suy hô hấp, tan máu, đông máu rải rác gr] the
...
# Duyệt qua các thực thể nhận diện được
for ent in doc.ents:
